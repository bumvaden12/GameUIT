...
void LoadResources()
{
	...
	sprites->Add(10041, 426, 0, 440, 16, texMario);			// stop small
	sprites->Add(10042, 6, 0, 20, 16, texMario);			//

	sprites->Add(10051, 425, 154, 425+16, 154+28, texMario);		// stop big
	sprites->Add(10052, 5, 154, 21, 154+28, texMario);				//
	...
	ani = new CAnimation(500);	// stop small
	ani->Add(10041);
	ani->Add(10042);
	animations->Add(504, ani);

	ani = new CAnimation(500); // stop big
	ani->Add(10051);
	ani->Add(10052);
	...
	mario->AddAnimation(504);		// stop small
	mario->AddAnimation(505);		// stop big
